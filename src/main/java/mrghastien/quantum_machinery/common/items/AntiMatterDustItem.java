...
import mrghastien.quantum_machinery.common.init.ModDamageSources;
...
public class AntiMatterDustItem extends Item {
	...
	public ItemStack onItemUseFinish(ItemStack stack, World worldIn, LivingEntity entityLiving) {
		...
		if (!worldIn.isRemote()) {
			worldIn.createExplosion(null, ModDamageSources.desintegrated, new ExplosionContext(), entityLiving.getPosX(),
