...
import static mrghastien.quantum_machinery.setup.Setup.MAIN_TAB;

import mrghastien.quantum_machinery.common.items.AntiMatterDustItem;
import mrghastien.quantum_machinery.common.items.AstroniumIngotItem;
import mrghastien.quantum_machinery.common.items.BatteryItem;
import mrghastien.quantum_machinery.common.items.WrenchItem;
...
public class ModItems {
	...
	public static final RegistryObject<Item> ASTRONIUM_HOE = ITEMS.register("astronium_hoe", () -> new HoeItem(ModToolMaterials.astronium, 4,-4 + 2.4f, ItemHelper.defaultProperties()));
