...
public abstract class PowerTransmitterContainer extends Container{

	protected InductorTile tileEntity;
	...
	protected PowerTransmitterContainer(ContainerType<?> type, int id, World world, BlockPos pos, PlayerInventory playerinventory, PlayerEntity player, InductorTile tileEntity, int size) {
		super(type, id);
