...
public abstract class BaseTile extends TileEntity implements ITickableTileEntity, INamedContainerProvider {
	...
	public BaseTile(TileEntityType<?> tileEntityTypeIn, int capacity,
			int maxTransfert) {
		this(tileEntityTypeIn, capacity, maxTransfert, maxTransfert);
	}

	public BaseTile(TileEntityType<?> tileEntityTypeIn, int capacity, int maxInput,
			int maxOutput) {
