...
import com.mrghastien.quantum_machinery.common.network.GuiSyncPacket;
...
import com.mrghastien.quantum_machinery.util.ClassUtils;

public abstract class MachineBaseContainer<T extends MachineBaseTile> extends Container {
	...
	protected MachineBaseContainer(ContainerType<?> type, int id, World world, BlockPos pos, PlayerInventory playerinventory, T tileEntity, int size) {
		super(type, id);
