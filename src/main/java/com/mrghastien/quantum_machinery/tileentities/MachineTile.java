...
public abstract class MachineTile extends TileEntity implements ITickableTileEntity, INamedContainerProvider {
	...
	public MachineTile(TileEntityType<?> tileEntityTypeIn, String containerRegistryNameIn, int capacity, int maxTransfert) {
		this(tileEntityTypeIn, containerRegistryNameIn, capacity, maxTransfert, maxTransfert);
	}
	
	public MachineTile(TileEntityType<?> tileEntityTypeIn, String containerRegistryNameIn, int capacity, int maxInput, int maxOutput) {
