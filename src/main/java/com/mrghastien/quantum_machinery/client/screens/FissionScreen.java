...
public class FissionScreen extends ContainerScreen<FissionContainer> {
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
		...
		this.blit(this.guiLeft + 178, this.guiTop + 7, 208, 0, 5, 88 - MathHelper.scale(fuelLevel, maxCapacity, 88));
		this.blit(this.guiLeft + 162, this.guiTop + 7, 208, 0, 5, 88 - MathHelper.scale(powerSurge, maxSurge, 88));
	}
